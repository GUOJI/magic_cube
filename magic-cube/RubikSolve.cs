...
namespace magic_cube
{
    ...
    //jack is here
    //a good cube ： UF UR UB UL DF DR DB DL FR FL BR BL UFR URB UBL ULF DRF DFL DLB DBR
    ...
    public class RubikSolve
    {
        ...
        // a good cube ： UF UR UB UL DF DR DB DL FR FL BR BL UFR URB UBL ULF DRF DFL DLB DBR
        // 宗蓝 白红 蓝黄 绿棕 棕白 红黄 黄绿 蓝白 红绿 红蓝 黄宗 绿白 棕白蓝 红白绿 棕白绿 黄绿棕 蓝红白 绿黄红 宗蓝黄 蓝红黄  

        // DL UF BL DR DF UB BR FL UR UL DB FR DFL UFR DRF DBR ULF URB DLB UBL
        //U3 L3 D1 U2 B2 F2 U1 L1 D1 L2 D1 B2 D1 F2 D2 R2 D1 D2 B2 U2 L2 B2 R2 F2 L2 D2 L2 U2 R2 
        //R 绿
        //L 蓝
        //F 白
        //B 黄
        ...
        //D 棕
            ...
            static public string getInput(CubeFace[,] projection)
        {
            if(projection[1,4].ToString()!="B" || projection[4, 1].ToString() != "L" || projection[4, 4].ToString() != "D")
            {
                return "需要位置初始化";
            }
            string rut =
               projection[9, 4].ToString() + projection[8, 4].ToString() + ' ' +
               projection[10, 5].ToString() + projection[4, 8].ToString() + ' ' +
               projection[11, 4].ToString() + projection[0, 4].ToString() + ' ' +
               projection[10, 3].ToString() + projection[4, 0].ToString() + ' ' +

               projection[5, 4].ToString() + projection[6, 4].ToString() + ' ' +
               projection[4, 5].ToString() + projection[4, 6].ToString() + ' ' +
               projection[3, 4].ToString() + projection[2, 4].ToString() + ' ' +
               projection[4, 3].ToString() + projection[4, 2].ToString() + ' ' +

               projection[7, 5].ToString() + projection[5, 7].ToString() + ' ' +
               projection[7, 3].ToString() + projection[5, 1].ToString() + ' ' +
               projection[1, 5].ToString() + projection[3, 7].ToString() + ' ' +
               projection[1, 3].ToString() + projection[3, 1].ToString() + ' ' +

               projection[9, 5].ToString() + projection[8, 5].ToString() + projection[5, 8].ToString() + ' ' +
               projection[11, 5].ToString() + projection[3, 8].ToString() + projection[0, 5].ToString() + ' ' +
               projection[11, 3].ToString() + projection[0, 3].ToString() + projection[3, 0].ToString() + ' ' +
               projection[9, 3].ToString() + projection[5, 0].ToString() + projection[8, 3].ToString() + ' ' +

               projection[5, 5].ToString() + projection[5, 6].ToString() + projection[6, 5].ToString() + ' ' +
               projection[5, 3].ToString() + projection[6, 3].ToString() + projection[5, 2].ToString() + ' ' +
               projection[3, 3].ToString() + projection[3, 2].ToString() + projection[2, 3].ToString() + ' ' +
               projection[3, 5].ToString() + projection[2, 5].ToString() + projection[3, 6].ToString();
            return rut;
        }
...
(RotationDirection)Enum.Parse(typeof(RotationDirection), "ClockWise")));
     ...
     (RotationDirection)Enum.Parse(typeof(RotationDirection), "ClockWise")));
        ...
        static public List<KeyValuePair<Move, RotationDirection>> getSolveMoves(string sInput)
        {
            List<KeyValuePair<Move, RotationDirection>> SolveMoves = new List<KeyValuePair<Move, RotationDirection>>();
            ...
            {
                int movecount = Convert.ToInt16(a[1].ToString());
                for (int i = 0; i < movecount; i++)
                {
                    SolveMoves.Add(new KeyValuePair<Move, RotationDirection>((Move)Enum.Parse(typeof(Move), a[0].ToString()),
                                     (RotationDirection)Enum.Parse(typeof(RotationDirection), "ClockWise")));
                }
            }
        ...
        static public string GetResult(string sInput)
        {
            ...
            sOutput = sOutput.Remove(sOutput.Count() - 1);
            return sOutput;
        }
    }
}
